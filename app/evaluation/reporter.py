...
def generate_markdown_summary(report: EvaluationReport) -> str:
    ...
    lines.extend([
        ...
        f"| **Citations** | Final Citation Integrity Rate | **{gen_sum.citation_integrity_rate * 100:.1f}%** | {gen_sum.total_answerable_cases} |",
        f"| **Generation Contract** | Traceable Answer Success Rate | **{gen_sum.traceable_answer_success_rate * 100:.1f}%** | {gen_sum.total_answerable_cases} |",
        "",
        "---",
        "",
